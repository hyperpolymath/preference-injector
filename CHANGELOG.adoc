...
* *Multiple Providers*: Use file, environment, API, and memory providers
together
...
* *React*: Hooks (`+usePreference+`, `+usePreferences+`) and context
provider
...
For more information, see the link:README.md[README].
