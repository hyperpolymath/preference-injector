...
This project follows the **Rhodium Standard Repository (RSR)
Framework**. Before submitting PRs, please verify compliance:
...
`MAINTAINERS.md` - Governance and TPCF - ✅ `.well-known/security.txt` -
RFC 9116 security contact - ✅ `.well-known/ai.txt` - AI training
policies - ✅ `.well-known/humans.txt` - Human contributors - ✅
