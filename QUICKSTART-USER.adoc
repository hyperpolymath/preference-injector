...
// Replace preference-injector, Preference Injector — See README.adoc for details., just run, Preference Injector started successfully. with actuals
= preference-injector — Quick Start for Users
:toc:
:toclevels: 2

== What is preference-injector?

Preference Injector — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./preference-injector-portable
----
...
[source]
----
Preference Injector started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/preference-injector/wiki
