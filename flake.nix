{
  description = "preference-injector - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P preference-injector.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/preference-injector $out/bin/  # Rust
            # cp bin/preference-injector $out/bin/  # Ada
          '';
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-preference-injector" {
